...
get the app created:
    ...
    $ heroku apps:create passgen
    Creating passgen... done, stack is cedar
    http://passgen.herokuapp.com/ | git@heroku.com:passgen.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://passgen.herokuapp.com deployed to Heroku

    To git@heroku.com:passgen.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://passgen.herokuap.com
    ["Hello" :from Heroku]
